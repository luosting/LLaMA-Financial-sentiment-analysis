...
project_dir="/apdcephfs_nj6/share_4274659/dihonggong/sent"
local_data_dir="/dockerdata"
src_checkpoint_dir="/apdcephfs_nj6/share_4274659/dihonggong/sent/checkpoints/llama2_7b_base"
...
train_command="train.py --load_ckpt_dir $dst_checkpoint_dir --save_ckpt_dir /dockerdata/rst_checkpoints --tokens_dir /apdcephfs_nj6/share_4274659/dihonggong/sent/data/reuters_tokens --tokenizer_model /apdcephfs_nj6/share_4274659/dihonggong/sent/checkpoints/llama2_7b_base/tokenizer.model  --micro_batch_size $MICRO_BATCH_SIZE --global_batch_size $GLOBAL_BATCH_SIZE --max_seq_len $MAX_SEQ_LENGTH --tensor_type $TENSOR_TYPE --warmup_tokens_b 0 --first_cycle_tokens_b 0.011 --max_lr 5e-5 --min_lr 5e-6 --grad_clip 0 --train_sft"
